...
def gcd(a, b):
  ...
  # K. VARELA COMMENT: The keys given to bez dictionary should be A and B.  Also, the formula for GCD of two integers u and v should be gcd(u, v) = u * bez[u] + v* bez[v]
